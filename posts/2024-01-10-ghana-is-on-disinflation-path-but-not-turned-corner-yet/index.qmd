---
title: "Ghana is on a disinflationary path but hasn't turned the corner yet"
date: "2024-01-10"
...
## Overall inflation is reducing but still high 
...
## End note 
Ghana is on a good path in terms of inflation. But it is important to exercise caution when declaring that we have turned the corner. Some risk to the inflation outlook include volatility in commodity prices, pressure on the Ghana cedi once we start repaying our external debts again and pass-through effect of new taxes and levies. There would be a time for jubilation but that time isn't now. 
